...
class TarjetasController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const tarjetas = yield database_1.default.query('SELECT * FROM tarjetas');
            res.json(tarjetas);
        });
    }
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const resultado = yield database_1.default.query('SELECT * FROM tarjetas WHERE id = ?', [id]);
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query('DELETE FROM tarjetas WHERE id = ?', [id]);
